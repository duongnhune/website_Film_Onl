...
<asp:MultiView ID="MultiView1" runat="server">
    ...
    <asp:View ID="View2" runat="server">
        ...
        <div class="col-lg-12 layout-spacing  px-3">
            ...
            <div runat="server">
                <div class="form-floating mb-3 col-xl-12 col-md-12 col-sm-12 col-12 has-valid">
                    ...
                    <asp:CustomValidator ID="validTxtTenPhimEn" runat="server" ValidateEmptyText="true" ControlToValidate="txtTenPhimEn" Enabled="true" OnServerValidate="validTxtTenPhimEn_ServerValidate" ClientValidationFunction="validTxtTenPhimEn_ClientValidate" CssClass="invalid-tooltip"></asp:CustomValidator>
                </div>
                <div class="form-floating mb-3 col-xl-12 col-md-12 col-sm-12 col-12 has-valid">
                    ...
                    <asp:CustomValidator ID="validTxtTenPhimVi" runat="server" ValidateEmptyText="true" ControlToValidate="txtTenPhimVi" Enabled="true" OnServerValidate="validTxtTenPhimVi_ServerValidate" ClientValidationFunction="validTxtTenPhimVi_ClientValidate" CssClass="invalid-tooltip"></asp:CustomValidator>
                </div>
                <div class="row mb-3">
                    <div class="form-floating col-xl-3 col-md-3 col-sm-3 col-3 has-valid">
                        <asp:DropDownList ID="drpDanhMuc" runat="server" CssClass="form-select is-invalid" placeholder="Danh mục *" OnLoad="drpDanhMuc_Load" EnableViewState="False">
                            <asp:ListItem Value="">-- Chọn Danh mục --</asp:ListItem>
                        </asp:DropDownList>
                        <label for="<%=drpDanhMuc.ClientID %>">Danh mục *</label>
                        <asp:CustomValidator ID="validDrpDanhMuc" runat="server" ValidateEmptyText="true" ControlToValidate="drpDanhMuc" Enabled="true" OnServerValidate="validDrpDanhMuc_ServerValidate" ClientValidationFunction="validDrpDanhMuc_ClientValidate" CssClass="invalid-tooltip"></asp:CustomValidator>
                    </div>
                    <div class="form-floating col-xl-3 col-md-3 col-sm-3 col-3 has-valid">
                        <asp:DropDownList ID="drpQuocGia" runat="server" CssClass="form-select is-invalid" placeholder="Quốc gia *" OnLoad="drpQuocGia_Load" EnableViewState="False">
                            <asp:ListItem Value="">-- Chọn Quốc gia --</asp:ListItem>
                        </asp:DropDownList>
                        <label for="<%=drpQuocGia.ClientID %>">Quốc gia *</label>
                        <asp:CustomValidator ID="validDrpQuocGia" runat="server" ValidateEmptyText="true" ControlToValidate="drpQuocGia" Enabled="true" OnServerValidate="validDrpQuocGia_ServerValidate" ClientValidationFunction="validDrpQuocGia_ClientValidate" CssClass="invalid-tooltip"></asp:CustomValidator>
                    </div>
                    <div class="form-floating col-xl-3 col-md-3 col-sm-3 col-3 has-valid">
                        <asp:DropDownList ID="drpNamPhatHanh" runat="server" CssClass="form-select is-invalid" placeholder="Năm phát hành *" OnLoad="drpNamPhatHanh_Load" EnableViewState="False">
                            <asp:ListItem Value="">-- Chọn năm phát hành --</asp:ListItem>
                        </asp:DropDownList>
                        <label for="<%=drpNamPhatHanh.ClientID %>">Năm phát hành *</label>
                        <asp:CustomValidator ID="validDrpNamPhatHanh" runat="server" ValidateEmptyText="true" ControlToValidate="drpNamPhatHanh" Enabled="true" OnServerValidate="validDrpNamPhatHanh_ServerValidate" ClientValidationFunction="validDrpNamPhatHanh_ClientValidate" CssClass="invalid-tooltip"></asp:CustomValidator>
                    </div>
                    <div class="form-floating col-xl-3 col-md-3 col-sm-3 col-3 has-valid">
                        ...
                        <asp:CustomValidator ID="validTxtThoiLuong" runat="server" ValidateEmptyText="true" ControlToValidate="txtThoiLuong" Enabled="true" OnServerValidate="validTxtThoiLuong_ServerValidate" ClientValidationFunction="validTxtThoiLuong_ClientValidate" CssClass="invalid-tooltip"></asp:CustomValidator>
                    </div>
                </div>
            </div>
            <div class="form-group mb-3 col-xl-12 col-md-12 col-sm-12 col-12 has-valid">
                <label for="<%=chkTheLoai.ClientID %>">Thể loại</label>
                <asp:CheckBoxList ID="chkTheLoai" runat="server" OnLoad="chkTheLoai_Load" RepeatDirection="Vertical" EnableViewState="False" CssClass="is-invalid checkbox__the-loai" OnDataBinding="chkTheLoai_Load"></asp:CheckBoxList>
                <asp:CustomValidator ID="validChkTheLoai" runat="server" EnableClientScript="true" OnServerValidate="validChkTheLoai_ServerValidate" ClientValidationFunction="validChkTheLoai_ClientValidate" ErrorMessage="Vui lòng chọn ít nhất 1 thể loại phim" CssClass="invalid-feedback"></asp:CustomValidator>
            </div>
            <div class="form-floating mb-3 col-xl-12 col-md-12 col-sm-12 col-12 has-valid">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtUrlPhim" ErrorMessage="Url phim là bắt buộc" CssClass="invalid-tooltip"></asp:RequiredFieldValidator>
            </div>
            <div class="form-group mb-3 col-xl-12 col-md-12 col-sm-12 col-12 has-valid">
                ...
                <asp:CustomValidator ID="validUploadHinh" runat="server" ValidateEmptyText="true" ControlToValidate="uploadHinh" Enabled="true" OnServerValidate="validUploadHinh_ServerValidate" CssClass="invalid-feedback"></asp:CustomValidator>
            ...
            <div class="input-group mb-3 col-xl-12 col-md-12 col-sm-12 col-12 has-valid">
                ...
                <asp:Button ID="btnInsertDirector" runat="server" CssClass="btn btn-primary" Text="Thêm mới" Enabled="False" OnClick="btnInsertDirector_Click" UseSubmitBehavior="False" />
                <asp:CustomValidator ID="validTxtDaoDien" runat="server" ValidateEmptyText="true" ControlToValidate="txtDaoDien" Enabled="true" OnServerValidate="validTxtDaoDien_ServerValidate" ClientValidationFunction="validTxtDaoDien_ClientValidate" CssClass="invalid-tooltip"></asp:CustomValidator>
            </div>
            <div class="input-group mb-3 col-xl-12 col-md-12 col-sm-12 col-12 has-valid">
                ...
                <asp:Button ID="btnInsertActor" runat="server" CssClass="btn btn-primary" Text="Thêm mới" Enabled="False" OnClick="btnInsertActor_Click" UseSubmitBehavior="False" />
        ...
        <script type="text/javascript">
            ...
            strRegexFormatField = /^(\w+\s*(;(\s*\w+)+)*)+$/gm;
